...
def run(args):
    ...
    episodes = task_setup.load_run_list(args, path_episode_root)[args.start_idx:args.end_idx:args.step_idx]

    # todo: remove below
    episodes.remove(Path('/home/hamish/Documents/robohop/hm3d/hm3d_iin_val/sharedata'))
    episodes.remove(Path('/home/hamish/Documents/robohop/hm3d/hm3d_iin_val/hm3d_v0.2'))
    episodes.remove(
        Path('/home/hamish/Documents/robohop/hm3d/hm3d_iin_val/hm3d_iin_val_topological_graphs_fast_sam_lightglue.zip')
    )
    ...
    for ei, path_episode in tqdm(
        ...
        #     success_status = f"{type(e).__name__}: {e} in {e_filename} #{exc_tb.tb_lineno}"
        #
...
if __name__ == "__main__":
    ...
    if not os.path.exists(config_file):
        print(f"Using default config file, create {config_file} to customise the parameters")
